...
def test_users(client: Client, owner_client: Client) -> None:
    ...
    create_user(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_members")
    tracker.start()
    get_members(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_single_user")
    tracker.start()
    get_single_user(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="deactivate_user")
    tracker.start()
    deactivate_user(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="reactivate_user")
    tracker.start()
    reactivate_user(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="update_user")
    tracker.start()
    update_user(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="update_status")
    tracker.start()
    update_status(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_user_status")
    tracker.start()
    get_user_status(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_user_by_email")
    tracker.start()
    get_user_by_email(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_subscription_status")
    tracker.start()
    get_subscription_status(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_user_channels")
    tracker.start()
    get_user_channels(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_profile")
    tracker.start()
    get_profile(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="update_settings")
    tracker.start()
    update_settings(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="upload_file")
    tracker.start()
    upload_file(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_attachments")
    tracker.start()
    attachment_id = get_attachments(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="remove_attachment")
    tracker.start()
    remove_attachment(client, attachment_id)
    tracker.stop()
    tracker = EmissionsTracker(project_name="set_typing_status")
    tracker.start()
    set_typing_status(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="update_presence")
    tracker.start()
    update_presence(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_user_presence")
    tracker.start()
    get_user_presence(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_presence")
    tracker.start()
    get_presence(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="create_user_group")
    tracker.start()
    create_user_group(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="user_group_id")
    tracker.start()
    user_group_id = get_user_groups(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="update_user_group")
    tracker.start()
    update_user_group(client, user_group_id)
    tracker.stop()
    tracker = EmissionsTracker(project_name="update_user_group_members")
    tracker.start()
    update_user_group_members(client, user_group_id)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_alert_words")
    tracker.start()
    get_alert_words(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="add_alert_words")
    tracker.start()
    add_alert_words(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="remove_alert_words")
    tracker.start()
    remove_alert_words(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="deactivate_own_user")
    tracker.start()
    deactivate_own_user(client, owner_client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="add_user_mute")
    tracker.start()
    add_user_mute(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="remove_user_mute")
    tracker.start()
    ...
    add_alert_words(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="add_navigation_views")
    tracker.start()
    add_navigation_views(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="get_navigation_views")
    tracker.start()
    get_navigation_views(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="update_navigation_views")
    tracker.start()
    update_navigation_views(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="remove_navigation_views")
    tracker.start()
    remove_navigation_views(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="create_saved_snippet_1")
    tracker.start()
    create_saved_snippet(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="create_saved_snippet_2")
    tracker.start()
    ...
    create_saved_snippet(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="saved_snippet_id")
    tracker.start()
    saved_snippet_id = get_saved_snippets(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="edit_saved_snippet")
    tracker.start()
    edit_saved_snippet(client, saved_snippet_id)
    tracker.stop()
    tracker = EmissionsTracker(project_name="delete_saved_snippet")
    tracker.start()
    ...
    remove_alert_words(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="add_apns_token")
    tracker.start()
    add_apns_token(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="remove_apns_token")
    tracker.start()
    remove_apns_token(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="add_fcm_token")
    tracker.start()
    add_fcm_token(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="remove_fcm_token")
    tracker.start()
    remove_fcm_token(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="register_push_device")
    tracker.start()
    register_push_device(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="register_device")
    tracker.start()
    register_device(client)
    tracker.stop()
    tracker = EmissionsTracker(project_name="remove_device")
    tracker.start()
